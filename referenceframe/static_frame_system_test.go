...
func TestSimpleFrameTranslation(t *testing.T) {
	...
	testTransformPoint(t, fs, &LinearInputs{}, poseWorld, poseFrame)
	testTransformPoint(t, fs, &LinearInputs{}, poseFrame, poseWorld)
}
...
func TestFrameTranslation(t *testing.T) {
	...
	testTransformPoint(t, fs, &LinearInputs{}, poseStart, poseEnd)
	testTransformPoint(t, fs, &LinearInputs{}, poseEnd, poseStart)
}
...
func TestGeomtriesTransform(t *testing.T) {
	...
	test.That(t, err, test.ShouldBeNil)
	tf, err := fs.Transform(&LinearInputs{}, geometries, "frame2")
	test.That(t, err, test.ShouldBeNil)
	...
	tf, err = fs.Transform(&LinearInputs{}, gf, "frame3")
	test.That(t, err, test.ShouldBeNil)
	framedGeometries, _ = tf.(*GeometriesInFrame)
...
func TestSystemSplitAndRejoin(t *testing.T) {
	...
	_, err = fs.Transform(&LinearInputs{}, NewPoseInFrame("frame4", spatial.NewPoseFromPoint(r3.Vector{2, 0, 0})), "frame2")
