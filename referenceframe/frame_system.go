...
// Clone returns a deep copy of the FrameSystem. Each frame is cloned
// individually and parent-child relationships are rebuilt via AddFrame, so
// mutations to the returned FrameSystem do not affect the original.
...
func (sfs *FrameSystem) Clone() (*FrameSystem, error) {
