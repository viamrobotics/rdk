...
set_target_properties(libjpeg-turbo::jpeg PROPERTIES
  IMPORTED_LOCATION_RELEASE "@@HOMEBREW_CELLAR@@/jpeg-turbo/2.1.5.1/lib/libjpeg.8.2.2.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libjpeg.8.dylib"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo::jpeg )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo::jpeg "@@HOMEBREW_CELLAR@@/jpeg-turbo/2.1.5.1/lib/libjpeg.8.2.2.dylib" )
...
set_target_properties(libjpeg-turbo::turbojpeg PROPERTIES
  IMPORTED_LOCATION_RELEASE "@@HOMEBREW_CELLAR@@/jpeg-turbo/2.1.5.1/lib/libturbojpeg.0.2.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libturbojpeg.0.dylib"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo::turbojpeg )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo::turbojpeg "@@HOMEBREW_CELLAR@@/jpeg-turbo/2.1.5.1/lib/libturbojpeg.0.2.0.dylib" )
...
set_target_properties(libjpeg-turbo::turbojpeg-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "@@HOMEBREW_CELLAR@@/jpeg-turbo/2.1.5.1/lib/libturbojpeg.a"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo::turbojpeg-static )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo::turbojpeg-static "@@HOMEBREW_CELLAR@@/jpeg-turbo/2.1.5.1/lib/libturbojpeg.a" )
...
set_target_properties(libjpeg-turbo::jpeg-static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "@@HOMEBREW_CELLAR@@/jpeg-turbo/2.1.5.1/lib/libjpeg.a"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo::jpeg-static )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo::jpeg-static "@@HOMEBREW_CELLAR@@/jpeg-turbo/2.1.5.1/lib/libjpeg.a" )
