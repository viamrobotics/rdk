...
func RegisterSummationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SummationServiceServer) error {
	...
	mux.Handle("POST", pattern_SummationService_Sum_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_SummationService_Sum_0(annotatedContext, inboundMarshaler, server, req, pathParams)
...
func RegisterSummationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SummationServiceClient) error {
	...
	mux.Handle("POST", pattern_SummationService_Sum_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SummationService_Sum_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_SummationService_Sum_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"acme", "api", "v1", "service", "summation", "name", "sum"}, ""))
)

var (
	forward_SummationService_Sum_0 = runtime.ForwardResponseMessage
)
