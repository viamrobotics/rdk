...
// AsSub tags s as the summation sub-resource of a composite, for resource.Compose. The Summation parameter
// type gives a compile-time check that s satisfies the summation API at the call site.
