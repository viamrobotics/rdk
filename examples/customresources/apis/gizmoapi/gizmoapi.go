...
// AsSub tags g as the gizmo sub-resource of a composite, for resource.Compose. The Gizmo parameter
// type gives a compile-time check that g satisfies the gizmo API at the call site. This mirrors the
