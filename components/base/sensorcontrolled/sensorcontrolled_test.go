...
func TestReconfig(t *testing.T) {
	...
	err = b.Reconfigure(ctx, deps, cfg)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, sb.velocities.Name().Name, test.ShouldResemble, "setvel1")
	...
	err = b.Reconfigure(ctx, deps, cfg)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, sb.velocities.Name().Name, test.ShouldResemble, "setvel2")
	...
	test.That(t, headingSupported, test.ShouldBeTrue)
	test.That(t, headingOri, test.ShouldEqual, orientationValue)
	test.That(t, sb.velocities.Name().Name, test.ShouldResemble, "setvel3")
	...
	test.That(t, headingSupported, test.ShouldBeTrue)
	test.That(t, headingOri, test.ShouldEqual, orientationValue)
	test.That(t, sb.velocities.Name().Name, test.ShouldResemble, "setvel4")
	...
	test.That(t, headingSupported, test.ShouldBeTrue)
	test.That(t, headingOri, test.ShouldEqual, orientationValue)
	test.That(t, sb.velocities.Name().Name, test.ShouldResemble, "setvel6")
	test.That(t, sb.position.Name().Name, test.ShouldResemble, "position1")

	deps, cfg = msDependencies(t, []string{"Bad", "setvel7", "position2", "compass2"})
	err = b.Reconfigure(ctx, deps, cfg)
	test.That(t, err, test.ShouldBeNil)
	test.That(t, sb.velocities.Name().Name, test.ShouldResemble, "setvel7")
	test.That(t, sb.position.Name().Name, test.ShouldResemble, "position2")
