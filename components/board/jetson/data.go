...
var claraAGXXavierPins = []genericlinux.PinDefinition{
	...
	{map[int]int{169: 51}, map[int]string{169: "PH.07"}, "2200000.gpio", 12, 18, "I2S2_CLK", "DAP2_SCLK", "", -1},
	{map[int]int{169: 96}, map[int]string{169: "PP.04"}, "2200000.gpio", 13, 27, "GPIO32", "SOC_GPIO04", "", -1},
	...
	{map[int]int{169: 162}, map[int]string{169: "PZ.05"}, "2200000.gpio", 19, 10, "SPI1_MOSI", "SPI1_MOSI", "", -1},
	{map[int]int{169: 161}, map[int]string{169: "PZ.04"}, "2200000.gpio", 21, 9, "SPI1_MISO", "SPI1_MISO", "", -1},
	{map[int]int{169: 101}, map[int]string{169: "PQ.01"}, "2200000.gpio", 22, 25, "GPIO17", "SOC_GPIO21", "", -1},
	{map[int]int{169: 160}, map[int]string{169: "PZ.03"}, "2200000.gpio", 23, 11, "SPI1_CLK", "SPI1_SCK", "", -1},
	{map[int]int{169: 163}, map[int]string{169: "PZ.06"}, "2200000.gpio", 24, 8, "SPI1_CS0_N", "SPI1_CS0_N", "", -1},
	{map[int]int{169: 164}, map[int]string{169: "PZ.07"}, "2200000.gpio", 26, 7, "SPI1_CS1_N", "SPI1_CS1_N", "", -1},
	{map[int]int{30: 3}, map[int]string{30: "PAA.03"}, "c2f0000.gpio", 29, 5, "CAN0_DIN", "CAN0_DIN", "", -1},
	{map[int]int{30: 2}, map[int]string{30: "PAA.02"}, "c2f0000.gpio", 31, 6, "CAN0_DOUT", "CAN0_DOUT", "", -1},
	{map[int]int{30: 9}, map[int]string{30: "PBB.01"}, "c2f0000.gpio", 32, 12, "GPIO9", "CAN1_EN", "", -1},
	{map[int]int{30: 0}, map[int]string{30: "PAA.00"}, "c2f0000.gpio", 33, 13, "CAN1_DOUT", "CAN1_DOUT", "", -1},
	{map[int]int{69: 54}, map[int]string{169: "PI.02"}, "2200000.gpio", 35, 19, "I2S2_FS", "DAP2_FS", "", -1},
	// Input-only (due to base board)
	{map[int]int{169: 113}, map[int]string{169: "PR.05"}, "2200000.gpio", 36, 16, "UART1_CTS", "UART1_CTS", "", -1},
	{map[int]int{30: 1}, map[int]string{30: "PAA.01"}, "c2f0000.gpio", 37, 26, "CAN1_DIN", "CAN1_DIN", "", -1},
	{map[int]int{69: 53}, map[int]string{169: "PI.01"}, "2200000.gpio", 38, 20, "I2S2_DIN", "DAP2_DIN", "", -1},
	{map[int]int{69: 52}, map[int]string{169: "PI.00"}, "2200000.gpio", 40, 21, "I2S2_DOUT", "DAP2_DOUT", "", -1},
}
...
var jetsonNXPins = []genericlinux.PinDefinition{
	{map[int]int{169: 118}, map[int]string{169: "PS.04"}, "2200000.gpio", 7, 4, "GPIO09", "AUD_MCLK", "", -1},
	{map[int]int{169: 112}, map[int]string{169: "PR.04"}, "2200000.gpio", 11, 17, "UART1_RTS", "UART1_RTS", "", -1},
	{map[int]int{169: 127}, map[int]string{169: "PT.05"}, "2200000.gpio", 12, 18, "I2S0_SCLK", "DAP5_SCLK", "", -1},
	{map[int]int{169: 149}, map[int]string{169: "PY.00"}, "2200000.gpio", 13, 27, "SPI1_SCK", "SPI3_SCK", "", -1},
	{map[int]int{30: 16}, map[int]string{30: "PCC.04"}, "c2f0000.gpio", 15, 22, "GPIO12", "TOUCH_CLK", "", -1},
	{map[int]int{169: 153}, map[int]string{169: "PY.04"}, "2200000.gpio", 16, 23, "SPI1_CS1", "SPI3_CS1_N", "", -1},
	{map[int]int{169: 152}, map[int]string{169: "PY.03"}, "2200000.gpio", 18, 24, "SPI1_CS0", "SPI3_CS0_N", "", -1},
	{map[int]int{169: 162}, map[int]string{169: "PZ.05"}, "2200000.gpio", 19, 10, "SPI0_MOSI", "SPI1_MOSI", "", -1},
	{map[int]int{169: 161}, map[int]string{169: "PZ.04"}, "2200000.gpio", 21, 9, "SPI0_MISO", "SPI1_MISO", "", -1},
	{map[int]int{169: 150}, map[int]string{169: "PY.01"}, "2200000.gpio", 22, 25, "SPI1_MISO", "SPI3_MISO", "", -1},
	{map[int]int{169: 160}, map[int]string{169: "PZ.03"}, "2200000.gpio", 23, 11, "SPI0_SCK", "SPI1_SCK", "", -1},
	{map[int]int{169: 163}, map[int]string{169: "PZ.06"}, "2200000.gpio", 24, 8, "SPI0_CS0", "SPI1_CS0_N", "", -1},
	{map[int]int{169: 164}, map[int]string{169: "PZ.07"}, "2200000.gpio", 26, 7, "SPI0_CS1", "SPI1_CS1_N", "", -1},
	{map[int]int{169: 105}, map[int]string{169: "PQ.05"}, "2200000.gpio", 29, 5, "GPIO01", "SOC_GPIO41", "", -1},
	{map[int]int{169: 106}, map[int]string{169: "PQ.06"}, "2200000.gpio", 31, 6, "GPIO11", "SOC_GPIO42", "", -1},
	{
		map[int]int{169: 108},
	...
	{map[int]int{169: 130}, map[int]string{169: "PU.00"}, "2200000.gpio", 35, 19, "I2S0_FS", "DAP5_FS", "", -1},
	{map[int]int{169: 113}, map[int]string{169: "PR.05"}, "2200000.gpio", 36, 16, "UART1_CTS", "UART1_CTS", "", -1},
	{map[int]int{169: 151}, map[int]string{169: "PY.02"}, "2200000.gpio", 37, 26, "SPI1_MOSI", "SPI3_MOSI", "", -1},
	{map[int]int{169: 129}, map[int]string{169: "PT.07"}, "2200000.gpio", 38, 20, "I2S0_DIN", "DAP5_DIN", "", -1},
	{map[int]int{169: 128}, map[int]string{169: "PT.06"}, "2200000.gpio", 40, 21, "I2S0_DOUT", "DAP5_DOUT", "", -1},
}
...
var jetsonXavierPins = []genericlinux.PinDefinition{
	...
	{map[int]int{30: 8}, map[int]string{30: "PBB.00"}, "c2f0000.gpio", 16, 23, "GPIO8", "CAN1_STB", "", -1},
	{
		map[int]int{169: 44},
		map[int]string{169: "PH.00"},
		"2200000.gpio",
	...
	{map[int]int{30: 9}, map[int]string{30: "PBB.01"}, "c2f0000.gpio", 32, 12, "GPIO9", "CAN1_EN", "", -1},
	{map[int]int{30: 0}, map[int]string{30: "PAA.00"}, "c2f0000.gpio", 33, 13, "CAN1_DOUT", "CAN1_DOUT", "", -1},
	{map[int]int{169: 54}, map[int]string{169: "PI.02"}, "2200000.gpio", 35, 19, "I2S2_FS", "DAP2_FS", "", -1},
	// Input-only (due to base board)
	{map[int]int{169: 113}, map[int]string{169: "PR.05"}, "2200000.gpio", 36, 16, "UART1_CTS", "UART1_CTS", "", -1},
	{map[int]int{30: 1}, map[int]string{30: "PAA.01"}, "c2f0000.gpio", 37, 26, "CAN1_DIN", "CAN1_DIN", "", -1},
	{map[int]int{169: 53}, map[int]string{169: "PI.01"}, "2200000.gpio", 38, 20, "I2S2_DIN", "DAP2_DIN", "", -1},
	{map[int]int{169: 52}, map[int]string{169: "PI.00"}, "2200000.gpio", 40, 21, "I2S2_DOUT", "DAP2_DOUT", "", -1},
}
