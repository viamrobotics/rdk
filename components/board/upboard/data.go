	...
	upboard: {
		[]genericlinux.PinDefinition{
			...
			*/
			...
			{Name: "32", DeviceName: "gpiochip4", LineNumber: 12, PwmChipSysfsDir: "0000:00:1a.0", PwmID: 1},
			{Name: "33", DeviceName: "gpiochip4", LineNumber: 13, PwmChipSysfsDir: "0000:00:1a.0", PwmID: 0},
