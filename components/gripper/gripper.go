...
// AsSub tags r as the gripper sub-resource of a composite, for resource.Compose. The Gripper parameter
// type gives a compile-time check that r satisfies the gripper API at the call site.
