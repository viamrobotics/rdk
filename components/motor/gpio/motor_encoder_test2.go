...
// func nowNanosTest2() uint64 {
// 	return uint64(time.Now().UnixNano())
// }

// type fakeDirectionAware2 struct {
// 	m *fakemotor.Motor
// }

// func (f *fakeDirectionAware2) DirectionMoving() int64 {
// 	return int64(f.m.Direction())
// }

// func TestMotorEncoder2(t *testing.T) {
...
// 	e.AttachDirectionalAwareness(&fakeDirectionAware2{m: fakeMotor})
...
// 		go func() {
// 			ticksErr := interrupt.Ticks(context.Background(), 99, nowNanosTest2())
// 			errChan <- ticksErr
// 		}()
...
// 		test.That(t, interrupt.Ticks(context.Background(), 1000, nowNanosTest2()), test.ShouldBeNil) // go far!
...
// 		test.That(t, interrupt.Ticks(context.Background(), 99, nowNanosTest2()), test.ShouldBeNil)
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			test.That(tb, fakeMotor.Direction(), test.ShouldEqual, 1)
// 		})

// 		test.That(t, interrupt.Tick(context.Background(), true, nowNanosTest2()), test.ShouldBeNil)
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
...
// func TestMotorEncoderIncremental2(t *testing.T) {
// 	logger := golog.NewTestLogger(t)
// 	undo := SetRPMSleepDebug(1, false)
// 	defer undo()
...
// 		test.That(t, encoderB.Tick(context.Background(), false, nowNanosTest2()), test.ShouldBeNil) // bounce, we should do nothing
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
...
// 		test.That(t, encoderA.Tick(context.Background(), false, nowNanosTest2()), test.ShouldBeNil)
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
// 			test.That(tb, pos, test.ShouldEqual, 0)
// 		})
// 		test.That(t, encoderB.Tick(context.Background(), true, nowNanosTest2()), test.ShouldBeNil) // we go from state 00 -> 10
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
...
// 		test.That(t, encoderA.Tick(context.Background(), true, nowNanosTest2()), test.ShouldBeNil) // 10 -> 11
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
...
// 		test.That(t, encoderB.Tick(context.Background(), false, nowNanosTest2()), test.ShouldBeNil) // 11 -> 01
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
...
// 		test.That(t, encoderA.Tick(context.Background(), false, nowNanosTest2()), test.ShouldBeNil) // 01 -> 00
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
...
// 		test.That(t, encoderA.Tick(context.Background(), true, nowNanosTest2()), test.ShouldBeNil) // we go from state 00 -> 01
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
// 			test.That(tb, pos, test.ShouldEqual, 3)
...
// 		test.That(t, encoderB.Tick(context.Background(), true, nowNanosTest2()), test.ShouldBeNil) // 01 -> 11
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
// 			test.That(tb, pos, test.ShouldEqual, 2)
...
// 		test.That(t, encoderA.Tick(context.Background(), false, nowNanosTest2()), test.ShouldBeNil) // 11 -> 10
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
// 			test.That(tb, pos, test.ShouldEqual, 1)
...
// 		test.That(t, encoderB.Tick(context.Background(), false, nowNanosTest2()), test.ShouldBeNil) // 10 -> 00
// 		testutils.WaitForAssertion(t, func(tb testing.TB) {
// 			tb.Helper()
// 			pos := encoder.RawPosition()
// 			test.That(tb, pos, test.ShouldEqual, 0)
...
// 		for x := 0; x < 100; x++ {
// 			test.That(t, encoderB.Tick(context.Background(), true, nowNanosTest2()), test.ShouldBeNil)
// 			test.That(t, encoderA.Tick(context.Background(), true, nowNanosTest2()), test.ShouldBeNil)
// 			test.That(t, encoderB.Tick(context.Background(), false, nowNanosTest2()), test.ShouldBeNil)
// 			test.That(t, encoderA.Tick(context.Background(), false, nowNanosTest2()), test.ShouldBeNil)
// 		}
...
// func TestWrapMotorWithEncoder2(t *testing.T) {
// 	logger := golog.NewTestLogger(t)
...
// func TestDirFlipMotor2(t *testing.T) {
// 	logger := golog.NewTestLogger(t)
...
// 	e := &single.Encoder{I: interrupt, CancelCtx: context.Background()}
// 	e.AttachDirectionalAwareness(&fakeDirectionAware2{m: dirflipFakeMotor})
// 	e.Start(context.Background())
