...
var modelname = resource.DefaultModelFamily.WithModel("TMC5072")
...
func init() {
	resource.RegisterComponent(motor.API, modelname, resource.Registration[motor.Motor, *TMC5072Config]{
		Constructor: func(
			ctx context.Context,
