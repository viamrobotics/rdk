...
// AsSub tags r as the input controller sub-resource of a composite, for resource.Compose. The Controller parameter
// type gives a compile-time check that r satisfies the input controller API at the call site.
