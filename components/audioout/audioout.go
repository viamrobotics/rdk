...
// AsSub tags r as the audio output sub-resource of a composite, for resource.Compose. The AudioOut parameter
// type gives a compile-time check that r satisfies the audio output API at the call site.
