...
// PiGPIO maps the error codes to the human readable error names. This can be found at the pigpio C interface.
var PiGPIOErrorMap = map[int]string{
	...
	-93:  "PI_NOT_SERVO_GPIO",                     // GPIO is not in use for servo pulses
