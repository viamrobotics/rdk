...
func (r *rtkStation) Position(ctx context.Context, extra types.ExtraParams) (*geo.Point, float64, error) {
	return &geo.Point{}, 0, movementsensor.ErrMethodUnimplementedPosition
}

func (r *rtkStation) LinearVelocity(ctx context.Context, extra types.ExtraParams) (r3.Vector, error) {
	return r3.Vector{}, movementsensor.ErrMethodUnimplementedLinearVelocity
}

func (r *rtkStation) AngularVelocity(ctx context.Context, extra types.ExtraParams) (spatialmath.AngularVelocity, error) {
	return spatialmath.AngularVelocity{}, movementsensor.ErrMethodUnimplementedAngularVelocity
}

func (r *rtkStation) Orientation(ctx context.Context, extra types.ExtraParams) (spatialmath.Orientation, error) {
	return spatialmath.NewZeroOrientation(), movementsensor.ErrMethodUnimplementedOrientation
}

func (r *rtkStation) CompassHeading(ctx context.Context, extra types.ExtraParams) (float64, error) {
...
func (r *rtkStation) Accuracy(ctx context.Context, extra types.ExtraParams) (map[string]float32, error) {
	return map[string]float32{}, movementsensor.ErrMethodUnimplementedAccuracy
}

func (r *rtkStation) Properties(ctx context.Context, extra types.ExtraParams) (*movementsensor.Properties, error) {
