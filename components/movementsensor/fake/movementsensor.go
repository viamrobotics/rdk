...
func (f *MovementSensor) Position(ctx context.Context, extra types.ExtraParams) (*geo.Point, float64, error) {
	p := geo.NewPoint(40.7, -73.98)
	return p, 50.5, nil
}

// LinearVelocity gets the linear velocity of a fake movementsensor.
func (f *MovementSensor) LinearVelocity(ctx context.Context, extra types.ExtraParams) (r3.Vector, error) {
	return r3.Vector{Y: 5.4}, nil
}

// AngularVelocity gets the angular velocity of a fake movementsensor.
func (f *MovementSensor) AngularVelocity(ctx context.Context, extra types.ExtraParams) (spatialmath.AngularVelocity, error) {
	return spatialmath.AngularVelocity{Z: 1}, nil
}

// CompassHeading gets the compass headings of a fake movementsensor.
func (f *MovementSensor) CompassHeading(ctx context.Context, extra types.ExtraParams) (float64, error) {
	return 25, nil
}

// Orientation gets the orientation of a fake movementsensor.
func (f *MovementSensor) Orientation(ctx context.Context, extra types.ExtraParams) (spatialmath.Orientation, error) {
...
func (f *MovementSensor) Accuracy(ctx context.Context, extra types.ExtraParams) (map[string]float32, error) {
...
func (f *MovementSensor) Properties(ctx context.Context, extra types.ExtraParams) (*movementsensor.Properties, error) {
