...
func (g *PmtkI2CNMEAMovementSensor) Position(ctx context.Context, extra types.ExtraParams) (*geo.Point, float64, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *PmtkI2CNMEAMovementSensor) Accuracy(ctx context.Context, extra types.ExtraParams) (map[string]float32, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *PmtkI2CNMEAMovementSensor) LinearVelocity(ctx context.Context, extra types.ExtraParams) (r3.Vector, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *PmtkI2CNMEAMovementSensor) AngularVelocity(ctx context.Context, extra types.ExtraParams) (spatialmath.AngularVelocity, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *PmtkI2CNMEAMovementSensor) CompassHeading(ctx context.Context, extra types.ExtraParams) (float64, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *PmtkI2CNMEAMovementSensor) Orientation(ctx context.Context, extra types.ExtraParams) (spatialmath.Orientation, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *PmtkI2CNMEAMovementSensor) Properties(ctx context.Context, extra types.ExtraParams) (*movementsensor.Properties, error) {
