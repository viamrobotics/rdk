...
func (g *SerialNMEAMovementSensor) Position(ctx context.Context, extra types.ExtraParams) (*geo.Point, float64, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *SerialNMEAMovementSensor) Accuracy(ctx context.Context, extra types.ExtraParams) (map[string]float32, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *SerialNMEAMovementSensor) LinearVelocity(ctx context.Context, extra types.ExtraParams) (r3.Vector, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *SerialNMEAMovementSensor) AngularVelocity(ctx context.Context, extra types.ExtraParams) (spatialmath.AngularVelocity, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *SerialNMEAMovementSensor) Orientation(ctx context.Context, extra types.ExtraParams) (spatialmath.Orientation, error) {
	return nil, movementsensor.ErrMethodUnimplementedOrientation
}

// CompassHeading 0->360.
func (g *SerialNMEAMovementSensor) CompassHeading(ctx context.Context, extra types.ExtraParams) (float64, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
...
func (g *SerialNMEAMovementSensor) Readings(ctx context.Context, extra types.ExtraParams) (map[string]interface{}, error) {
...
func (g *SerialNMEAMovementSensor) Properties(ctx context.Context, extra types.ExtraParams) (*movementsensor.Properties, error) {
