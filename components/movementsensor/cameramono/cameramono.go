...
func (co *cameramono) Position(ctx context.Context, extra types.ExtraParams) (*geo.Point, float64, error) {
...
func (co *cameramono) Orientation(ctx context.Context, extra types.ExtraParams) (spatialmath.Orientation, error) {
...
func (co *cameramono) LinearVelocity(ctx context.Context, extra types.ExtraParams) (r3.Vector, error) {
	return co.result.linVel, nil
}

// AngularVelocity gets the position of the moving object calculated by visual odometry.
func (co *cameramono) AngularVelocity(ctx context.Context, extra types.ExtraParams) (spatialmath.AngularVelocity, error) {
	return co.result.angVel, nil
}

// Properties gets the position of the moving object calculated by visual odometry.
func (co *cameramono) Properties(ctx context.Context, extra types.ExtraParams) (*movementsensor.Properties, error) {
...
func (co *cameramono) Accuracy(ctx context.Context, extra types.ExtraParams) (map[string]float32, error) {
	return map[string]float32{}, movementsensor.ErrMethodUnimplementedAccuracy
}

// COmpassHeadings gets the position of the moving object calculated by visual odometry.
func (co *cameramono) CompassHeading(ctx context.Context, extra types.ExtraParams) (float64, error) {
