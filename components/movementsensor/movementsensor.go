...
//
// [movement sensor component docs]: https://docs.viam.com/reference/components/movement-sensor/
...
// AsSub tags ms as the movement-sensor sub-resource of a composite, for resource.Compose.
