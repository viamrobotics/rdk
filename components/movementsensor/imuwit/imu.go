...
func (imu *wit) AngularVelocity(ctx context.Context, extra types.ExtraParams) (spatialmath.AngularVelocity, error) {
	imu.mu.Lock()
	defer imu.mu.Unlock()
	return imu.angularVelocity, imu.lastError
}

func (imu *wit) LinearVelocity(ctx context.Context, extra types.ExtraParams) (r3.Vector, error) {
	imu.mu.Lock()
	defer imu.mu.Unlock()
	return r3.Vector{}, movementsensor.ErrMethodUnimplementedLinearVelocity
}

func (imu *wit) Orientation(ctx context.Context, extra types.ExtraParams) (spatialmath.Orientation, error) {
	imu.mu.Lock()
	defer imu.mu.Unlock()
...
func (imu *wit) CompassHeading(ctx context.Context, extra types.ExtraParams) (float64, error) {
	return 0, movementsensor.ErrMethodUnimplementedCompassHeading
}

func (imu *wit) Position(ctx context.Context, extra types.ExtraParams) (*geo.Point, float64, error) {
	return geo.NewPoint(0, 0), 0, movementsensor.ErrMethodUnimplementedPosition
}

func (imu *wit) Accuracy(ctx context.Context, extra types.ExtraParams) (map[string]float32, error) {
	return map[string]float32{}, movementsensor.ErrMethodUnimplementedAccuracy
}

func (imu *wit) Readings(ctx context.Context, extra types.ExtraParams) (map[string]interface{}, error) {
...
func (imu *wit) Properties(ctx context.Context, extra types.ExtraParams) (*movementsensor.Properties, error) {
