...
func TestClient(t *testing.T) {
	...
	test.That(t, resourceAPI.RegisterRPCService(context.Background(), rpcServer, encoderSvc, logger), test.ShouldBeNil)
	...
	t.Run("client tests for working encoder", func(t *testing.T) {
		...
		statusResult, err := workingEncoderClient.Status(context.Background())
		test.That(t, err, test.ShouldBeNil)
