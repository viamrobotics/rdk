...
func TestNewCamera(t *testing.T) {
	...
	cam2, err := camera.NewFromReader(context.Background(), videoSrc, &transform.PinholeCameraModel{intrinsics1, nil}, camera.DepthStream)
	test.That(t, err, test.ShouldBeNil)
	...
	test.That(t, err, test.ShouldBeNil)
	cam3, err := camera.NewFromReader(context.Background(), videoSrc, &transform.PinholeCameraModel{cam2props.IntrinsicParams, nil}, camera.DepthStream)
	test.That(t, err, test.ShouldBeNil)
	...
	cam4, err := camera.NewFromReader(context.Background(), videoSrc, &transform.PinholeCameraModel{intrinsics2, nil}, camera.DepthStream)
	test.That(t, err, test.ShouldBeNil)
	...
	cam5, err := camera.NewFromReader(context.Background(), videoSrc, &transform.PinholeCameraModel{props.IntrinsicParams, nil}, camera.DepthStream)
	test.That(t, err, test.ShouldBeNil)
...
func TestCameraWithProjector(t *testing.T) {
	...
	cam, err := camera.NewFromReader(context.Background(), videoSrc, &transform.PinholeCameraModel{params1, nil}, camera.DepthStream)
	test.That(t, err, test.ShouldBeNil)
	...
	test.That(t, err, test.ShouldBeNil)
	cam2, err := camera.NewFromReader(context.Background(), videoSrc2, &transform.PinholeCameraModel{props.IntrinsicParams, nil}, camera.DepthStream)
	test.That(t, err, test.ShouldBeNil)
