...
// 		MergeMethod:   "naive",
// 	}
// 	joinedCam, err := newJoinPointCloudCamera(context.Background(), deps, conf, utils.Logger)
// 	test.That(t, err, test.ShouldBeNil)
...
// 		MergeMethod:   "naive",
// 	}
// 	joinedCam2, err := newJoinPointCloudCamera(context.Background(), deps, conf2, utils.Logger)
// 	test.That(t, err, test.ShouldBeNil)
