...
var chars = [][]int{
    []int{0, 0, 0, 21, 0, 1},         // 0x20 ' '
    []int{0, 5, 22, 21, 8, -21},      // 0x21 '!'
    []int{14, 11, 10, 21, 5, -20},    // 0x22 '"'
    []int{28, 16, 25, 21, 3, -22},    // 0x23 '#'
    []int{78, 14, 28, 21, 4, -23},    // 0x24 '$'
    []int{127, 15, 21, 21, 3, -20},   // 0x25 '%'
    []int{167, 15, 20, 21, 3, -19},   // 0x26 '&'
    []int{205, 4, 10, 21, 8, -20},    // 0x27 '''
    []int{210, 8, 27, 21, 9, -21},    // 0x28 '('
    []int{237, 8, 27, 21, 4, -21},    // 0x29 ')'
    []int{264, 16, 15, 21, 3, -21},   // 0x2A '*'
    []int{294, 16, 19, 21, 3, -18},   // 0x2B '+'
    []int{332, 7, 10, 21, 5, -3},     // 0x2C ','
    []int{341, 19, 4, 21, 1, -11},    // 0x2D '-'
    []int{351, 5, 5, 21, 8, -4},      // 0x2E '.'
    []int{355, 15, 28, 21, 3, -23},   // 0x2F '/'
    []int{408, 16, 23, 21, 3, -22},   // 0x30 '0'
    []int{454, 15, 22, 21, 3, -21},   // 0x31 '1'
    []int{496, 15, 23, 21, 3, -22},   // 0x32 '2'
    []int{540, 16, 23, 21, 3, -22},   // 0x33 '3'
    []int{586, 15, 21, 21, 3, -20},   // 0x34 '4'
    []int{626, 17, 22, 21, 2, -21},   // 0x35 '5'
    []int{673, 15, 23, 21, 4, -22},   // 0x36 '6'
    []int{717, 15, 22, 21, 3, -21},   // 0x37 '7'
    []int{759, 15, 23, 21, 3, -22},   // 0x38 '8'
    []int{803, 15, 23, 21, 4, -22},   // 0x39 '9'
    []int{847, 5, 16, 21, 8, -15},    // 0x3A ':'
    []int{857, 7, 22, 21, 5, -15},    // 0x3B ';'
    []int{877, 18, 16, 21, 1, -17},   // 0x3C '<'
    []int{913, 19, 10, 21, 1, -14},   // 0x3D '='
    []int{937, 18, 16, 21, 2, -17},   // 0x3E '>'
    []int{973, 15, 21, 21, 4, -20},   // 0x3F '?'
    []int{1013, 15, 27, 21, 3, -21},  // 0x40 '@'
    []int{1064, 22, 21, 21, -1, -20}, // 0x41 'A'
    []int{1122, 20, 21, 21, 1, -20},  // 0x42 'B'
    []int{1175, 19, 21, 21, 1, -20},  // 0x43 'C'
    []int{1225, 18, 21, 21, 2, -20},  // 0x44 'D'
    []int{1273, 19, 21, 21, 1, -20},  // 0x45 'E'
    []int{1323, 19, 21, 21, 1, -20},  // 0x46 'F'
    []int{1373, 20, 21, 21, 1, -20},  // 0x47 'G'
    []int{1426, 21, 21, 21, 0, -20},  // 0x48 'H'
    []int{1482, 14, 21, 21, 4, -20},  // 0x49 'I'
    []int{1519, 19, 21, 21, 2, -20},  // 0x4A 'J'
    []int{1569, 20, 21, 21, 1, -20},  // 0x4B 'K'
    []int{1622, 18, 21, 21, 2, -20},  // 0x4C 'L'
    []int{1670, 23, 21, 21, -1, -20}, // 0x4D 'M'
    []int{1731, 20, 21, 21, 1, -20},  // 0x4E 'N'
    []int{1784, 20, 21, 21, 1, -20},  // 0x4F 'O'
    []int{1837, 18, 21, 21, 1, -20},  // 0x50 'P'
    []int{1885, 20, 26, 21, 1, -20},  // 0x51 'Q'
    []int{1950, 21, 21, 21, 0, -20},  // 0x52 'R'
    []int{2006, 17, 21, 21, 2, -20},  // 0x53 'S'
    []int{2051, 19, 21, 21, 1, -20},  // 0x54 'T'
    []int{2101, 21, 21, 21, 0, -20},  // 0x55 'U'
    []int{2157, 23, 21, 21, -1, -20}, // 0x56 'V'
    []int{2218, 21, 21, 21, 0, -20},  // 0x57 'W'
    []int{2274, 19, 21, 21, 1, -20},  // 0x58 'X'
    []int{2324, 20, 21, 21, 1, -20},  // 0x59 'Y'
    []int{2377, 16, 21, 21, 3, -20},  // 0x5A 'Z'
    []int{2419, 8, 27, 21, 9, -21},   // 0x5B '['
    []int{2446, 15, 28, 21, 3, -23},  // 0x5C '\'
    []int{2499, 8, 27, 21, 4, -21},   // 0x5D ']'
    []int{2526, 15, 11, 21, 3, -21},  // 0x5E '^'
    []int{2547, 21, 4, 21, 0, 4},     // 0x5F '_'
    []int{2558, 6, 6, 21, 6, -22},    // 0x60 '`'
    []int{2563, 19, 16, 21, 1, -15},  // 0x61 'a'
    []int{2601, 19, 22, 21, 1, -21},  // 0x62 'b'
    []int{2654, 17, 16, 21, 2, -15},  // 0x63 'c'
    []int{2688, 20, 22, 21, 1, -21},  // 0x64 'd'
    []int{2743, 18, 16, 21, 1, -15},  // 0x65 'e'
    []int{2779, 16, 22, 21, 4, -21},  // 0x66 'f'
    []int{2823, 19, 23, 21, 1, -15},  // 0x67 'g'
    []int{2878, 21, 22, 21, 0, -21},  // 0x68 'h'
    []int{2936, 16, 22, 21, 3, -21},  // 0x69 'i'
    []int{2980, 12, 29, 21, 5, -21},  // 0x6A 'j'
    []int{3024, 18, 22, 21, 2, -21},  // 0x6B 'k'
    []int{3074, 16, 22, 21, 3, -21},  // 0x6C 'l'
    []int{3118, 22, 16, 21, -1, -15}, // 0x6D 'm'
    []int{3162, 20, 16, 21, 0, -15},  // 0x6E 'n'
    []int{3202, 19, 16, 21, 1, -15},  // 0x6F 'o'
    []int{3240, 21, 23, 21, 0, -15},  // 0x70 'p'
    []int{3301, 21, 23, 22, 1, -15},  // 0x71 'q'
    []int{3362, 17, 16, 21, 3, -15},  // 0x72 'r'
    []int{3396, 16, 16, 21, 3, -15},  // 0x73 's'
    []int{3428, 17, 21, 21, 1, -20},  // 0x74 't'
    []int{3473, 18, 16, 21, 1, -15},  // 0x75 'u'
    []int{3509, 21, 16, 21, 0, -15},  // 0x76 'v'
    []int{3551, 21, 16, 21, 0, -15},  // 0x77 'w'
    []int{3593, 19, 16, 21, 1, -15},  // 0x78 'x'
    []int{3631, 19, 23, 21, 1, -15},  // 0x79 'y'
    []int{3686, 14, 16, 21, 3, -15},  // 0x7A 'z'
    []int{3714, 10, 27, 21, 6, -21},  // 0x7B '{'
    []int{3748, 4, 27, 21, 9, -21},   // 0x7C '|'
    []int{3762, 10, 27, 21, 6, -21},  // 0x7D '}'
    []int{3796, 17, 8, 21, 2, -13}}  // 0x7E '~'
