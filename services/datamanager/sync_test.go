...
func compareMetadata(t *testing.T, actualMetadata *v1.UploadMetadata,
	...
	// TODO [DATA-164]: Figure out how to construct the test case filename (in expected) to be the same as the actual
	// filename that is generated by viamUpload(ctx, client, path). ONCE COMPLETE, UNCOMMENT THE FOLLOWING:
