...
func TestConfig(t *testing.T) {
	...
	t.Run("captureConfig())", func(t *testing.T) {
		t.Run("returns a capture config with deafults when called on an empty config", func(t *testing.T) {
			c := &Config{}
	...
	t.Run("syncConfig())", func(t *testing.T) {
		t.Run("returns a sync config with deafults when called on an empty config", func(t *testing.T) {
			c := &Config{}
