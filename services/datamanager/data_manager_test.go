...
// NOTE: The test below does not account for edge cases.
// E.g. if the model already exists we should not re-deploy,
//      if there is a partial download, how we do know to continue deployment
// TODO: fix
...
func TestModelDeploy(t *testing.T) {
	...
	// defer removing the file generated by mock client Do function
	defer os.Remove("README.txt")
