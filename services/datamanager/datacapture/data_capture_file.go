...
// DataCaptureMetadata builds a DataCaptureMetadata object.
func DataCaptureMetadata(compType resource.SubtypeName, compName string, compModel string, method string,
