...
// AsSub tags s as the navigation sub-resource of a composite, for resource.Compose. The Service parameter
// type gives a compile-time check that s satisfies the navigation API at the call site.
