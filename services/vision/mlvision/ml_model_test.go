...
func TestNewMLDetector(t *testing.T) {
	...
	test.That(t, gotDetections[0].BoundingBox().Min.Y, test.ShouldBeLessThan, 43)
	test.That(t, gotDetections[0].BoundingBox().Max.X, test.ShouldBeGreaterThan, 196)
	test.That(t, gotDetections[0].BoundingBox().Max.X, test.ShouldBeLessThan, 200)
	test.That(t, gotDetections[0].BoundingBox().Max.Y, test.ShouldBeGreaterThan, 160)
	...
	test.That(t, gotDetectionsNL[0].BoundingBox().Min.Y, test.ShouldBeLessThan, 43)
