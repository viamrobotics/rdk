...
func TestNewMLDetector(t *testing.T) {
	...
	test.That(t, gotDetections[0].BoundingBox().Min.X, test.ShouldBeGreaterThanOrEqualTo, 125)
	test.That(t, gotDetections[0].BoundingBox().Min.X, test.ShouldBeLessThanOrEqualTo, 127)
	test.That(t, gotDetections[0].BoundingBox().Min.Y, test.ShouldBeGreaterThanOrEqualTo, 41)
	test.That(t, gotDetections[0].BoundingBox().Min.Y, test.ShouldBeLessThanOrEqualTo, 43)
	test.That(t, gotDetections[0].BoundingBox().Max.X, test.ShouldBeGreaterThanOrEqualTo, 196)
	test.That(t, gotDetections[0].BoundingBox().Max.X, test.ShouldBeLessThanOrEqualTo, 200)
	test.That(t, gotDetections[0].BoundingBox().Max.Y, test.ShouldBeGreaterThanOrEqualTo, 160)
	test.That(t, gotDetections[0].BoundingBox().Max.Y, test.ShouldBeLessThanOrEqualTo, 163)
	...
	test.That(t, gotDetectionsNL[0].BoundingBox().Min.X, test.ShouldBeGreaterThanOrEqualTo, 125)
	test.That(t, gotDetectionsNL[0].BoundingBox().Min.X, test.ShouldBeLessThanOrEqualTo, 127)
	test.That(t, gotDetectionsNL[0].BoundingBox().Min.Y, test.ShouldBeGreaterThanOrEqualTo, 41)
	test.That(t, gotDetectionsNL[0].BoundingBox().Min.Y, test.ShouldBeLessThanOrEqualTo, 44)
	test.That(t, gotDetectionsNL[0].BoundingBox().Max.X, test.ShouldBeGreaterThanOrEqualTo, 196)
	test.That(t, gotDetectionsNL[0].BoundingBox().Max.X, test.ShouldBeLessThanOrEqualTo, 200)
	test.That(t, gotDetectionsNL[0].BoundingBox().Max.Y, test.ShouldBeGreaterThanOrEqualTo, 160)
	test.That(t, gotDetectionsNL[0].BoundingBox().Max.Y, test.ShouldBeLessThanOrEqualTo, 163)
