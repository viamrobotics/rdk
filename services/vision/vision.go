...
// AsSub tags s as the vision sub-resource of a composite, for resource.Compose. The Service parameter
// type gives a compile-time check that s satisfies the vision API at the call site.
