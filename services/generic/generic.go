...
// AsSub tags s as the generic sub-resource of a composite, for resource.Compose. The Service parameter
// type gives a compile-time check that s satisfies the generic API at the call site.
