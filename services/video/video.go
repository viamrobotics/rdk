...
// AsSub tags s as the video sub-resource of a composite, for resource.Compose. The Service parameter
// type gives a compile-time check that s satisfies the video API at the call site.
