...
// AsSub tags s as the ML model sub-resource of a composite, for resource.Compose. The Service parameter
// type gives a compile-time check that s satisfies the ML model API at the call site.
