...
// GetPointCloudMapStream creates a request, calls the slam algorithms GetPointCloudMapStream endpoint and returns a callback function
...
// GetInternalStateStream creates a request, calls the slam algorithms GetInternalStateStream endpoint and returns a callback function
