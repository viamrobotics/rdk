...
// AsSub tags s as the SLAM sub-resource of a composite, for resource.Compose. The Service parameter
// type gives a compile-time check that s satisfies the SLAM API at the call site.
