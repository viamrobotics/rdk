...
func NewMovementSensorLocalizer(origin *geo.Point, calibration spatialmath.Pose) Localizer {
	return &movementSensorLocalizer{origin: origin, calibration: calibration}
}
