...
func TestClient(t *testing.T) {
	...
	t.Run("motion client 1", func(t *testing.T) {
		...
		result, err := client.Move(context.Background(), resourceName, grabPose, &referenceframe.WorldState{}, nil, map[string]interface{}{})
		test.That(t, err, test.ShouldBeNil)
	...
	t.Run("motion client 2", func(t *testing.T) {
		...
		resp, err := client2.Move(context.Background(), resourceName, grabPose, &referenceframe.WorldState{}, nil, map[string]interface{}{})
