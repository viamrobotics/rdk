...
func TestDepthColorIntrinsicsExtrinsics(t *testing.T) {
	...
	depthIntrinsics, err := NewPinholeCameraIntrinsicsFromJSONFile(intel515Path, "depth")
	...
	colorIntrinsics, err2 := NewPinholeCameraIntrinsicsFromJSONFile(intel515Path, "color")
	...
	sensorParams, err3 := NewDepthColorIntrinsicsExtrinsicsFromJSONFile(intel515Path)
