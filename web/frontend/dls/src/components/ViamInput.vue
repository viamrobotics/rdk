  ...
  <label class="block">
    ...
    <div class="flex">
      ...
      <div class="relative flex-grow">
        ...
        <input
          ref="input"
          class="appearance-none block w-full border text-gray-700 dark:text-gray-200 placeholder-gray-400 leading-tight dark:placeholder-gray-500 focus:outline-none transition-colors duration-150 ease-in-out"
          :class="[
            disabled
    ...
    <p v-if="$slots.error" class="text-sm text-danger-500 mt-1">
      <slot name="error" />
    </p>

    <p v-if="$slots.success" class="text-sm text-success-500 mt-1">
      <slot name="success" />
    </p>
  </label>
</template>
