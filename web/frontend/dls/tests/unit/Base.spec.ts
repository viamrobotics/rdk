...
describe("Base", () => {
  ...
  it("click tabs", async () => {
    ...
    const keyboardColumnWrapper = wrapper.find(".grid button:first-child span:last-child span");
    ...
    const divColumnWrapper = wrapper.find(".column button:first-child span:last-child");
  ...
  it("click discrete arc", async () => {
    ...
    await lastButton.trigger('click');
    expect(lastButton.attributes("aria-selected")).toBe("true");
    const divColumnWrapper = wrapper.find(".column button:nth-child(2) span:first-child");
  ...
  it("click discrete arc", async () => {
    ...
    expect(wrapper.vm.$data.direction).toBe('Forwards');
    expect(wrapper.vm.$data.spinType).toBe('Clockwise');
    const backwardColumnWrapper = wrapper.find(".flex:nth-child(2) button:nth-child(2) span:first-child");
  ...
  it("click discrete arc", async () => {
    ...
    await backwardColumnWrapper.trigger('click');
    expect(wrapper.vm.$data.direction).toBe('Backwards');
    const ccwColumnWrapper = wrapper.find(".flex:nth-child(3) button:nth-child(2) span:first-child");
  ...
  it("click discrete spin", async () => {
    ...
    await lastButton.trigger('click');
    expect(lastButton.attributes("aria-selected")).toBe("true");
    const divColumnWrapper = wrapper.find(".column button:nth-child(3) span:first-child");
