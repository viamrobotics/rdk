...
<template>
  ...
  >
    ...
    <div class="overflow-auto border border-t-0 border-border-1 p-4">
      ...
      <table class="mb-4 table-auto border border-border-1">
        <tr
      ...
      <table class="mb-4 w-full table-auto border border-border-1">
        <tr
        ...
        <tr>
          ...
          <td class="p-2">
            <div class="flex flex-wrap items-end gap-2">
              ...
              <select
                v-model="setLevel"
                class="mr-2 h-[30px] border border-border-1 bg-white text-sm"
              >
                <option>low</option>
                <option>high</option>
              </select>
