...
window.inputApi = require('proto/api/component/v1/input_controller_pb.js');
const { InputControllerServiceClient } = require('proto/api/component/v1/input_controller_pb_service.js');
