...
type ServoServiceGetPosition = {
  ...
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof proto_api_component_v1_servo_pb.ServoServiceGetPositionRequest;
  readonly responseType: typeof proto_api_component_v1_servo_pb.ServoServiceGetPositionResponse;
};
...
export class ServoServiceClient {
  ...
  getPosition(
    requestMessage: proto_api_component_v1_servo_pb.ServoServiceGetPositionRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: proto_api_component_v1_servo_pb.ServoServiceGetPositionResponse|null) => void
  ): UnaryResponse;
  getPosition(
    requestMessage: proto_api_component_v1_servo_pb.ServoServiceGetPositionRequest,
    callback: (error: ServiceError|null, responseMessage: proto_api_component_v1_servo_pb.ServoServiceGetPositionResponse|null) => void
