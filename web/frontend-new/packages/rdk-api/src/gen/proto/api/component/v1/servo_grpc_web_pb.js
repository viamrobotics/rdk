 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.proto.api.component.v1.ServoServiceGetPositionRequest,
 *   !proto.proto.api.component.v1.ServoServiceGetPositionResponse>}
 */
const methodDescriptor_ServoService_GetPosition = new grpc.web.MethodDescriptor(
  ...
  proto.proto.api.component.v1.ServoServiceGetPositionResponse,
  /**
   * @param {!proto.proto.api.component.v1.ServoServiceGetPositionRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.proto.api.component.v1.ServoServiceGetPositionResponse.deserializeBinary
);


/**
 * @param {!proto.proto.api.component.v1.ServoServiceGetPositionRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.proto.api.component.v1.ServoServiceGetPositionResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.proto.api.component.v1.ServoServiceGetPositionResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.proto.api.component.v1.ServoServiceClient.prototype.getPosition =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/proto.api.component.v1.ServoService/GetPosition',
      request,
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.proto.api.component.v1.ServoServiceGetPositionResponse>}
 *     Promise that resolves to the response
 */
proto.proto.api.component.v1.ServoServicePromiseClient.prototype.getPosition =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/proto.api.component.v1.ServoService/GetPosition',
      request,
