...
go test -tags=no_skip $RACE $COVER1 `go list ./... | grep -Ev "go.viam.com/rdk/(vision|rimage|component/camera/imagesource)"` &
PID1=$!
go test -tags=no_skip $TIMEOUT $COVER2 go.viam.com/rdk/vision/... go.viam.com/rdk/rimage/... go.viam.com/rdk/component/camera/imagesource &
PID2=$!
