...
sudo apt -y update
sudo apt -y upgrade
sudo apt -y install cheese  wiringpi git autoconf swig yasm cmake libxext-dev git v4l-utils apt-file pigpio-tools libx264-dev libmicrohttpd-dev libtool libpigpio-dev
