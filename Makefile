...
deb-server: server
	...
	install -m 644 -D robot/web/templates/*.html --target-directory=packaging/work/viam-server-0.1/usr/share/viam/templates/
	install -m 644 -D robot/web/frontend/dist/* --target-directory=packaging/work/viam-server-0.1/usr/share/viam/static/
