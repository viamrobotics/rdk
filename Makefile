...
deb-server: server cameras
	...
	install -m 644 -D web/runtime-shared/static/third-party/ace/* --target-directory=etc/packaging/work/viam-server-$(SERVER_DEB_VER)/usr/share/viam/static/third-party/ace
