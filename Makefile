...
cover:
	...
	go test -coverprofile=coverage2.txt -covermode=atomic go.viam.com/robotcore/vision/... go.viam.com/robotcore/rimage/imagesource/...
	sed '1d' coverage2.txt >> coverage.txt

test:
	go test -race ./...
	go test go.viam.com/robotcore/vision/... go.viam.com/robotcore/rimage/imagesource/...
