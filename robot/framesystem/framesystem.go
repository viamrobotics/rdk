...
type Service interface {
	...
	CurrentInputs(ctx context.Context) (referenceframe.FrameConfigurations, map[string]InputEnabled, error)
...
func (svc *frameSystemService) CurrentInputs(
	ctx context.Context,
) (referenceframe.FrameConfigurations, map[string]InputEnabled, error) {
