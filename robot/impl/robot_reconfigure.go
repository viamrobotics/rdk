...
func newDraftRobot(r *localRobot, diff *config.Diff) *draftRobot {
	return &draftRobot{
		...
		diff:          diff,
		parts:         r.parts.Clone(),
		additions:     newRobotParts(r.parts.debug, r.parts.allowInsecureCreds, r.parts.tlsConfig, r.logger),
		modifications: newRobotParts(r.parts.debug, r.parts.allowInsecureCreds, r.parts.tlsConfig, r.logger),
		removals:      newRobotParts(r.parts.debug, r.parts.allowInsecureCreds, r.parts.tlsConfig, r.logger),
	}
}
