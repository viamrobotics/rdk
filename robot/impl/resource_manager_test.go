...
func TestUpdateConfig(t *testing.T) {
	...
	registry.RegisterService(Subtype, resource.BuiltIntModelName, registry.Service{
	...
	svc1 := config.Service{Name: "", Model: resource.BuiltIntModelName, Namespace: resource.ResourceNamespaceRDK, Type: "testSubType"}
