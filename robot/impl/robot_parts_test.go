...
func TestPartsForRemoteRobot(t *testing.T) {
	...
	test.That(t, ok, test.ShouldBeFalse)
	resource1, ok := parts.ResourceByName("core:component:arm/arm1")
	test.That(t, ok, test.ShouldBeTrue)
...
func TestPartsMergeNamesWithRemotes(t *testing.T) {
	...
	test.That(t, ok, test.ShouldBeTrue)
	test.That(t, resource1.(*fake.Arm).Name, test.ShouldEqual, "arm1")
	resource1, ok = parts.ResourceByName("core:component:arm/arm1_r1")
	test.That(t, ok, test.ShouldBeTrue)
	test.That(t, resource1.(*fake.Arm).Name, test.ShouldEqual, "arm1_r1")
	resource1, ok = parts.ResourceByName("core:component:arm/arm1_r2")
	test.That(t, ok, test.ShouldBeTrue)
	test.That(t, resource1.(*fake.Arm).Name, test.ShouldEqual, "arm1_r2")
	_, ok = parts.ResourceByName("core:component:arm/arm1_what")
	test.That(t, ok, test.ShouldBeFalse)
}
...
func TestPartsClone(t *testing.T) {
	...
	resource1, ok := newParts.ResourceByName("core:component:arm/arm1")
	test.That(t, ok, test.ShouldBeTrue)
	test.That(t, resource1.(*fake.Arm).Name, test.ShouldEqual, "arm1")
	resource1, ok = newParts.ResourceByName("core:component:arm/arm1_r1")
	test.That(t, ok, test.ShouldBeTrue)
	test.That(t, resource1.(*fake.Arm).Name, test.ShouldEqual, "arm1_r1")
	resource1, ok = newParts.ResourceByName("core:component:arm/arm1_r2")
	test.That(t, ok, test.ShouldBeTrue)
	test.That(t, resource1.(*fake.Arm).Name, test.ShouldEqual, "arm1_r2")
	_, ok = newParts.ResourceByName("core:component:arm/arm1_what")
	test.That(t, ok, test.ShouldBeFalse)
...
func TestPartsMergeAdd(t *testing.T) {
	...
	checkEmpty := func(toCheck *robotParts) {
		...
		test.That(t, utils.NewStringSet(toCheck.ResourceNames()...), test.ShouldBeEmpty)
	...
	test.That(t, utils.NewStringSet(emptyParts.ResourceNames()...), test.ShouldBeEmpty)
...
func TestPartsMergeRemove(t *testing.T) {
	...
	test.That(t, utils.NewStringSet(parts.ResourceNames()...), test.ShouldBeEmpty)
