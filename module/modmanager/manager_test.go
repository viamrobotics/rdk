...
func TestModManagerFunctions(t *testing.T) {
	...
	t.Run("AddModuleHelpers", func(t *testing.T) {
	...
	t.Run("NeedsModule", func(t *testing.T) {
		ok := mgr.NeedsModule(cfgCounter1)
		...
		ok = mgr.NeedsModule(cfg2)
		test.That(t, ok, test.ShouldBeFalse)
	})

	var counter generic.Generic
	...
	t.Run("IsModularResource", func(t *testing.T) {
