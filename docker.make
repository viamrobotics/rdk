...
BUILD_CMD = docker buildx build --pull $(BUILD_PUSH) --force-rm --no-cache --build-arg BASE_TAG=$(BUILD_TAG) --platform linux/$(BUILD_TAG) -f etc/Dockerfile.cache -t '$(MAIN_TAG):$(BUILD_TAG)-cache' .
BUILD_PUSH = --load
