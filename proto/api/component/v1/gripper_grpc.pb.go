...
type GripperServiceClient interface {
	...
	Open(ctx context.Context, in *GripperServiceOpenRequest, opts ...grpc.CallOption) (*GripperServiceOpenResponse, error)
	// Grab requests a gripper of the underlying robot to grab.
	Grab(ctx context.Context, in *GripperServiceGrabRequest, opts ...grpc.CallOption) (*GripperServiceGrabResponse, error)
}
...
func (c *gripperServiceClient) Open(ctx context.Context, in *GripperServiceOpenRequest, opts ...grpc.CallOption) (*GripperServiceOpenResponse, error) {
	out := new(GripperServiceOpenResponse)
	err := c.cc.Invoke(ctx, "/proto.api.component.v1.GripperService/Open", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gripperServiceClient) Grab(ctx context.Context, in *GripperServiceGrabRequest, opts ...grpc.CallOption) (*GripperServiceGrabResponse, error) {
	out := new(GripperServiceGrabResponse)
	err := c.cc.Invoke(ctx, "/proto.api.component.v1.GripperService/Grab", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GripperServiceServer interface {
	// Open opens a gripper of the underlying robot.
	Open(context.Context, *GripperServiceOpenRequest) (*GripperServiceOpenResponse, error)
	// Grab requests a gripper of the underlying robot to grab.
	Grab(context.Context, *GripperServiceGrabRequest) (*GripperServiceGrabResponse, error)
...
func (UnimplementedGripperServiceServer) Open(context.Context, *GripperServiceOpenRequest) (*GripperServiceOpenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Open not implemented")
}
func (UnimplementedGripperServiceServer) Grab(context.Context, *GripperServiceGrabRequest) (*GripperServiceGrabResponse, error) {
...
func _GripperService_Open_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GripperServiceOpenRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.api.component.v1.GripperService/Open",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GripperServiceServer).Open(ctx, req.(*GripperServiceOpenRequest))
	}
...
func _GripperService_Grab_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GripperServiceGrabRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.api.component.v1.GripperService/Grab",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GripperServiceServer).Grab(ctx, req.(*GripperServiceGrabRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GripperService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.api.component.v1.GripperService",
	...
	Metadata: "proto/api/component/v1/gripper.proto",
}
