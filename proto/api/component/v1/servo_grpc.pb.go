...
func (c *servoServiceClient) Move(ctx context.Context, in *ServoServiceMoveRequest, opts ...grpc.CallOption) (*ServoServiceMoveResponse, error) {
	out := new(ServoServiceMoveResponse)
	err := c.cc.Invoke(ctx, "/proto.api.component.v1.ServoService/Move", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ServoService_Move_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServoServiceMoveRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.api.component.v1.ServoService/Move",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServoServiceServer).Move(ctx, req.(*ServoServiceMoveRequest))
	}
...
var ServoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.api.component.v1.ServoService",
	...
	Metadata: "proto/api/component/v1/servo.proto",
}
