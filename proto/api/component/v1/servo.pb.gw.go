...
func request_ServoService_Move_0(ctx context.Context, marshaler runtime.Marshaler, client ServoServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ServoServiceMoveRequest
...
func RegisterServoServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ServoServiceServer) error {
	...
	mux.Handle("PUT", pattern_ServoService_Move_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.api.component.v1.ServoService/Move", runtime.WithHTTPPathPattern("/api/v1/component/servo/{name}/move"))
		if err != nil {
...
func RegisterServoServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ServoServiceClient) error {
	...
	mux.Handle("PUT", pattern_ServoService_Move_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/proto.api.component.v1.ServoService/Move", runtime.WithHTTPPathPattern("/api/v1/component/servo/{name}/move"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
