...
func RegisterSensorServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SensorServiceServer) error {
	...
	mux.Handle("GET", pattern_SensorService_GetReadings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.api.component.sensor.v1.SensorService/GetReadings", runtime.WithHTTPPathPattern("/viam/api/v1/component/sensor/{name}/readings"))
		if err != nil {
...
func RegisterSensorServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SensorServiceClient) error {
	...
	mux.Handle("GET", pattern_SensorService_GetReadings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.api.component.sensor.v1.SensorService/GetReadings", runtime.WithHTTPPathPattern("/viam/api/v1/component/sensor/{name}/readings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
