...
var (
	filter_FrameSystemService_Config_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_FrameSystemService_Config_0(ctx context.Context, marshaler runtime.Marshaler, client FrameSystemServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FrameSystemService_Config_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func request_FrameSystemService_TransformPose_0(ctx context.Context, marshaler runtime.Marshaler, client FrameSystemServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FrameSystemService_TransformPose_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_FrameSystemService_TransformPose_0(ctx context.Context, marshaler runtime.Marshaler, server FrameSystemServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TransformPoseRequest
	var metadata runtime.ServerMetadata
...
func RegisterFrameSystemServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FrameSystemServiceServer) error {
	...
	mux.Handle("GET", pattern_FrameSystemService_TransformPose_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.api.service.framesystem.v1.FrameSystemService/TransformPose", runtime.WithHTTPPathPattern("/viam/api/v1/service/frame_system/transform_pose"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FrameSystemService_TransformPose_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_FrameSystemService_TransformPose_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterFrameSystemServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FrameSystemServiceClient) error {
	...
	mux.Handle("GET", pattern_FrameSystemService_TransformPose_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/proto.api.service.framesystem.v1.FrameSystemService/TransformPose", runtime.WithHTTPPathPattern("/viam/api/v1/service/frame_system/transform_pose"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FrameSystemService_TransformPose_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
