...
type ObjectSegmentationServiceClient interface {
	...
	GetObjectPointClouds(ctx context.Context, in *ObjectSegmentationServiceGetObjectPointCloudsRequest, opts ...grpc.CallOption) (*ObjectSegmentationServiceGetObjectPointCloudsResponse, error)
}
...
func (c *objectSegmentationServiceClient) GetObjectPointClouds(ctx context.Context, in *ObjectSegmentationServiceGetObjectPointCloudsRequest, opts ...grpc.CallOption) (*ObjectSegmentationServiceGetObjectPointCloudsResponse, error) {
	out := new(ObjectSegmentationServiceGetObjectPointCloudsResponse)
	err := c.cc.Invoke(ctx, "/proto.api.service.v1.ObjectSegmentationService/GetObjectPointClouds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ObjectSegmentationServiceServer interface {
	...
	// as well as the 3-vector center of each of the found objects.
	// A specific MIME type can be requested but may not necessarily be the same one returned.
	GetObjectPointClouds(context.Context, *ObjectSegmentationServiceGetObjectPointCloudsRequest) (*ObjectSegmentationServiceGetObjectPointCloudsResponse, error)
...
func (UnimplementedObjectSegmentationServiceServer) GetObjectPointClouds(context.Context, *ObjectSegmentationServiceGetObjectPointCloudsRequest) (*ObjectSegmentationServiceGetObjectPointCloudsResponse, error) {
...
func _ObjectSegmentationService_GetObjectPointClouds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ObjectSegmentationServiceGetObjectPointCloudsRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.api.service.v1.ObjectSegmentationService/GetObjectPointClouds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ObjectSegmentationServiceServer).GetObjectPointClouds(ctx, req.(*ObjectSegmentationServiceGetObjectPointCloudsRequest))
	}
...
var ObjectSegmentationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.api.service.v1.ObjectSegmentationService",
	...
	Metadata: "proto/api/service/v1/object_segmentation.proto",
}
