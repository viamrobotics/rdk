...
func (c *Camera) NextPointCloud(ctx context.Context, extra map[string]interface{}) (pointcloud.PointCloud, error) {
	if c.NextPointCloudFunc != nil {
		return errtrace.Wrap2(c.NextPointCloudFunc(ctx, extra))
	}
	if c.Camera != nil {
		return errtrace.Wrap2(c.Camera.NextPointCloud(ctx, extra))
	}
	return nil, errtrace.Wrap(errors.New("NextPointCloud unimplemented"))
}
...
func (c *Camera) Properties(ctx context.Context) (camera.Properties, error) {
	if c.PropertiesFunc == nil {
		return errtrace.Wrap2(c.Camera.Properties(ctx))
	}
	return errtrace.Wrap2(c.PropertiesFunc(ctx))
}
...
func (c *Camera) Images(
	...
	if c.ImagesFunc != nil {
		return errtrace.Wrap3(c.ImagesFunc(ctx, filterSourceNames, extra))
	}

	if c.Camera != nil {
		return errtrace.Wrap3(c.Camera.Images(ctx, filterSourceNames, extra))
	}

	return nil, resource.ResponseMetadata{}, errtrace.Wrap(errors.New("Images unimplemented"))
}

// Status calls the injected Status or the real version.
func (c *Camera) Status(ctx context.Context) (map[string]interface{}, error) {
	if c.StatusFunc != nil {
		return errtrace.Wrap2(c.StatusFunc(ctx))
	}
	if c.Camera != nil {
		return errtrace.Wrap2(c.Camera.Status(ctx))
	}
...
func (c *Camera) Close(ctx context.Context) error {
	if c.CloseFunc != nil {
		return errtrace.Wrap(c.CloseFunc(ctx))
	}
	if c.Camera != nil {
		return errtrace.Wrap(c.Camera.Close(ctx))
	}
	return nil
}
...
func (c *Camera) DoCommand(ctx context.Context, cmd map[string]interface{}) (map[string]interface{}, error) {
	if c.DoFunc != nil {
		return errtrace.Wrap2(c.DoFunc(ctx, cmd))
	}
	return errtrace.Wrap2(c.Camera.DoCommand(ctx, cmd))
}
...
func (c *Camera) Geometries(ctx context.Context, cmd map[string]interface{}) ([]spatialmath.Geometry, error) {
	if c.GeometriesFunc != nil {
		return errtrace.Wrap2(c.GeometriesFunc(ctx, cmd))
	}
	return errtrace.Wrap2(c.Camera.Geometries(ctx, cmd))
}
...
func (c *Camera) SubscribeRTP(
	...
	if c.RTPPassthroughSource != nil {
		return errtrace.Wrap2(c.RTPPassthroughSource.SubscribeRTP(ctx, bufferSize, packetsCB))
	}
...
func (c *Camera) Unsubscribe(ctx context.Context, id rtppassthrough.SubscriptionID) error {
	if c.RTPPassthroughSource != nil {
		return errtrace.Wrap(c.RTPPassthroughSource.Unsubscribe(ctx, id))
	}
