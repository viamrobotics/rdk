...
type SLAMServiceClient struct {
	...
	GetPositionFunc      func(ctx context.Context, in *v1.GetPositionRequest, opts ...grpc.CallOption) (*v1.GetPositionResponse, error)
	GetPointCloudMapFunc func(ctx context.Context, in *v1.GetPointCloudMapRequest, opts ...grpc.CallOption) (v1.SLAMService_GetPointCloudMapClient, error)
	GetInternalStateFunc func(ctx context.Context, in *v1.GetInternalStateRequest, opts ...grpc.CallOption) (v1.SLAMService_GetInternalStateClient, error)
	DoCommandFunc        func(ctx context.Context, in *commonv1.DoCommandRequest, opts ...grpc.CallOption) (*commonv1.DoCommandResponse, error)
}

// GetPosition calls the injected GetPositionFunc or the real version.
func (slamSvcClient *SLAMServiceClient) GetPosition(ctx context.Context, in *v1.GetPositionRequest, opts ...grpc.CallOption) (*v1.GetPositionResponse, error) {
...
// GetPointCloudMap calls the injected GetPointCloudMap or the real version.
func (slamSvcClient *SLAMServiceClient) GetPointCloudMap(ctx context.Context, in *v1.GetPointCloudMapRequest, opts ...grpc.CallOption) (v1.SLAMService_GetPointCloudMapClient, error) {
...
// GetInternalState calls the injected GetInternalState or the real version.
func (slamSvcClient *SLAMServiceClient) GetInternalState(ctx context.Context, in *v1.GetInternalStateRequest, opts ...grpc.CallOption) (v1.SLAMService_GetInternalStateClient, error) {
...
// DoCommand calls the injected DoCommand or the real variant.
func (slamSvcClient *SLAMServiceClient) DoCommand(ctx context.Context, in *commonv1.DoCommandRequest, opts ...grpc.CallOption) (*commonv1.DoCommandResponse, error) {
