...
type FrameSystemService struct {
	...
	CurrentInputsFunc func(ctx context.Context) (referenceframe.FrameConfigurations, map[string]framesystem.InputEnabled, error)
...
func (fs *FrameSystemService) CurrentInputs(
	ctx context.Context,
) (referenceframe.FrameConfigurations, map[string]framesystem.InputEnabled, error) {
