...
var (
	...
	// Log write timeouts when not behind a proxy and when behind a proxy.
	// Network operations behind a proxy tend to take longer, so we triple the
	// timeout to allow more consistent net logging.
