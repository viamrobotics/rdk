...
var boardInfoMappings = map[string]commonsysfs.BoardInformation{
	bbAi: {
		PinDefinitions: []commonsysfs.PinDefinition{
			...
			{map[int]int{128: 9}, map[int]string{}, "600000.gpio", 838, 0, "P8_38A", "", "", -1},
			{map[int]int{128: 10}, map[int]string{}, "600000.gpio", 923, 0, "P9_23", "", "", -1},
			{map[int]int{128: 12}, map[int]string{}, "600000.gpio", 926, 0, "P9_26B", "", "", -1},
			...
			{map[int]int{128: 24}, map[int]string{}, "600000.gpio", 835, 0, "P8_35A", "", "", -1},
			{map[int]int{128: 25}, map[int]string{}, "600000.gpio", 833, 0, "P8_33A", "", "", -1},
			{map[int]int{128: 26}, map[int]string{}, "600000.gpio", 832, 0, "P8_32A", "", "", -1},
			{map[int]int{128: 28}, map[int]string{}, "600000.gpio", 917, 0, "P9_17A", "", "", -1},
			{map[int]int{128: 30}, map[int]string{}, "600000.gpio", 821, 0, "P8_21", "", "", -1},
			{map[int]int{128: 31}, map[int]string{}, "600000.gpio", 823, 0, "P8_23", "", "", -1},
			{map[int]int{128: 32}, map[int]string{}, "600000.gpio", 831, 0, "P8_31A", "", "", -1},
			...
			{map[int]int{128: 48}, map[int]string{}, "600000.gpio", 804, 0, "P8_04 (BOOTMODE2)", "", "", -1},
			{map[int]int{128: 50}, map[int]string{}, "600000.gpio", 933, 0, "P9_33B", "", "", -1},
			{map[int]int{128: 51}, map[int]string{}, "600000.gpio", 826, 0, "P8_26", "", "", -1},
			{map[int]int{128: 52}, map[int]string{}, "600000.gpio", 931, 0, "P9_31B", "", "", -1},
			{map[int]int{128: 53}, map[int]string{}, "600000.gpio", 929, 0, "P9_29B", "", "", -1},
			{map[int]int{128: 54}, map[int]string{}, "600000.gpio", 939, 0, "P9_39B", "", "", -1},
			{map[int]int{128: 55}, map[int]string{}, "600000.gpio", 935, 0, "P9_35B", "", "", -1},
			{map[int]int{128: 56}, map[int]string{}, "600000.gpio", 936, 0, "P9_36B", "", "", -1},
			{map[int]int{128: 57}, map[int]string{}, "600000.gpio", 937, 0, "P9_37B", "", "", -1},
			{map[int]int{128: 58}, map[int]string{}, "600000.gpio", 938, 0, "P9_38B", "", "", -1},
			{map[int]int{128: 59}, map[int]string{}, "600000.gpio", 812, 0, "P8_12", "", "", -1},
			{map[int]int{128: 60}, map[int]string{}, "600000.gpio", 811, 0, "P8_11 (BOOTMODE7)", "", "", -1},
			...
			{map[int]int{128: 68}, map[int]string{}, "600000.gpio", 842, 0, "P8_42 (BOOTMODE6)", "", "", -1},
			...
			{map[int]int{128: 78}, map[int]string{}, "600000.gpio", 919, 0, "P9_19B", "", "", -1},
