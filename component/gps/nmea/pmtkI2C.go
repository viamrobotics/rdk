...
// func (g *pmtkI2CNMEAGPS) Receive(config config.Component) {
// 	//get caster config for ntrip
...
// 	//assuming the handle.Read is how we read data bytes from I2C
// 	//feading this string buffer into ntripclient getstream the same way as we do in serial
// 	//HAVE NOT TESTED
// 	if hErr != nil {
...
// 	//assuming getstream works the same for both serial and I2C
...
// 	}
	...
	//Check for disconnect using rtcm3
