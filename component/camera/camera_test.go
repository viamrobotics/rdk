...
func TestNewCamera(t *testing.T) {
	...
	cam2, err := camera.FromImageSource(imgSrc, proj, true)
	test.That(t, err, test.ShouldBeNil)
	...
	cam3, err := camera.FromImageSource(imgSrc, proj, true)
	test.That(t, err, test.ShouldBeNil)
	...
	cam4, err := camera.FromImageSource(imgSrc, proj, true)
	test.That(t, err, test.ShouldBeNil)
	...
	cam5, err := camera.FromImageSource(imgSrc, proj, true)
	test.That(t, err, test.ShouldBeNil)
...
func TestCameraWithNoProjector(t *testing.T) {
	imgSrc := &simpleSource{"rimage/board1"}
	noProj, err := camera.FromImageSource(imgSrc, nil, false)
	test.That(t, err, test.ShouldBeNil)
	...
	noProj2, err := camera.FromImageSource(imgSrc2, nil, true)
	test.That(t, err, test.ShouldBeNil)
...
func TestCameraWithProjector(t *testing.T) {
	...
	cam, err := camera.FromImageSource(imgSrc, proj, true)
	test.That(t, err, test.ShouldBeNil)
	...
	cam2, err := camera.FromImageSource(imgSrc2, proj, true)
	test.That(t, err, test.ShouldBeNil)
