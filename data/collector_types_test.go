...
func TestGetFileExt(t *testing.T) {
	...
	test.That(t, getFileExt(CaptureTypeBinary, "ReadImage", map[string]interface{}{"mime_type": rutils.MimeTypeJPEG}), test.ShouldResemble, ".jpeg")
	test.That(t, getFileExt(CaptureTypeBinary, "ReadImage", map[string]interface{}{"mime_type": rutils.MimeTypePNG}), test.ShouldResemble, ".png")
	test.That(t, getFileExt(CaptureTypeBinary, "ReadImage", map[string]interface{}{"mime_type": rutils.MimeTypePCD}), test.ShouldResemble, ".pcd")
}
