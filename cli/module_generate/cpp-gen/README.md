# Viam C++ SDK module generator (Draft Proof of Concept)

This is a proof of concept module generator for the Viam C++ SDK. Very schematically, the basic inputs are
- SDK component you want to implement
- C++ SDK build directory containing a `compile_commands.json` (automatically generated by the SDK CMake project)
- C++ SDK source directory, the root of the `viam-cpp-sdk` git project.
...
For now the CLI inherits the interface of a Clang command line tool, so the interface is
