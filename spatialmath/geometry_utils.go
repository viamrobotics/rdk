...
// ClosestPointOnLineSegment takes a line segment defined by pt1 and pt2, plus some query point, and returns the point on the line segment
...
// ClosestPointsBetweenSegments will return the points at which two line segments are closest to one another
