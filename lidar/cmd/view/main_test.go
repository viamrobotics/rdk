...
func TestMainMain(t *testing.T) {
	...
	registry.RegisterLidar("fail_scan", registry.LidarRegistration{Constructor: func(ctx context.Context, r robot.Robot, config config.Component, logger golog.Logger) (lidar.Lidar, error) {
		dev := &inject.Lidar{Lidar: fake.NewLidar("")}
		var once bool
