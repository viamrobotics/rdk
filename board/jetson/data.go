...
var (
	boardInfoMappings = map[string]struct {
		...
		claraAGXXavier: {
			[]pinDefinition{
				...
				{map[int]int{224: 105, 169: 84}, map[int]string{169: "PN.01"}, "2200000.gpio", 15, 22, "GPIO27", "SOC_GPIO54", "3280000.pwm", 0},
				{map[int]int{40: 8, 30: 8}, map[int]string{30: "PBB.00"}, "c2f0000.gpio", 16, 23, "GPIO8", "CAN1_STB", "", -1},
				{map[int]int{224: 56, 169: 44}, map[int]string{169: "PH.00"}, "2200000.gpio", 18, 24, "GPIO35", "SOC_GPIO12", "32c0000.pwm", 0},
		...
		jetsonNX: {
			[]pinDefinition{
				...
				{map[int]int{224: 136, 169: 108}, map[int]string{169: "PR.00"}, "2200000.gpio", 32, 12, "GPIO07", "SOC_GPIO44", "32f0000.pwm", 0},
				{map[int]int{224: 105, 169: 84}, map[int]string{169: "PN.01"}, "2200000.gpio", 33, 13, "GPIO13", "SOC_GPIO54", "3280000.pwm", 0},
		...
		jetsonXavier: {
			[]pinDefinition{
				...
				{map[int]int{224: 140, 169: 112}, map[int]string{169: "PR.04"}, "2200000.gpio", 11, 17, "UART1_RTS", "UART1_RTS", "", -1},
				{map[int]int{224: 63, 169: 51}, map[int]string{169: "PH.07"}, "2200000.gpio", 12, 18, "I2S2_CLK", "DAP2_SCLK", "", -1},
				{map[int]int{224: 136, 169: 108}, map[int]string{169: "PR.00"}, "2200000.gpio", 13, 27, "PWM01", "SOC_GPIO44", "32f0000.pwm", 0},
				// Older versions of L4T don't enable this PWM controller in DT, so this PWM
				// channel may not be available.
				{map[int]int{224: 105, 169: 84}, map[int]string{169: "PN.01"}, "2200000.gpio", 15, 22, "GPIO27", "SOC_GPIO54", "3280000.pwm", 0},
				{map[int]int{40: 8, 30: 8}, map[int]string{30: "PBB.00"}, "c2f0000.gpio", 16, 23, "GPIO8", "CAN1_STB", "", -1},
		...
		jetsonTX2: {
			[]pinDefinition{
				...
				{map[int]int{192: 77, 140: 67}, map[int]string{140: "PJ.05"}, "2200000.gpio", 13, 27, "PGPIO20_AUD_INT", "GPIO_AUD0", "", -1},
				...
				{map[int]int{192: 161, 140: 128}, map[int]string{140: "PY.01"}, "2200000.gpio", 18, 24, "GPIO16_MDM_WAKE_AP", "GPIO_MDM2", "", -1},
				...
				{map[int]int{192: 69, 140: 59}, map[int]string{140: "PI.05"}, "2200000.gpio", 33, 13, "GPIO11_AP_WAKE_BT", "GPIO_PQ5", "", -1},
				...
				{map[int]int{192: 68, 140: 58}, map[int]string{140: "PI.04"}, "2200000.gpio", 37, 26, "GPIO8_ALS_PROX_INT", "GPIO_PQ4", "", -1},
