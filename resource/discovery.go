...
type (
	...
	DiscoveryFunc func(ctx context.Context, logger logging.Logger, extra interface{}) (interface{}, error)
...
func NewDiscoveryQuery(api API, model Model, extra interface{}) DiscoveryQuery {
