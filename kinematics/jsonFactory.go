...
var world = "world"
var worldFrame = frame.NewStaticFrame("world", nil)
	...
	if m.Model.KinParamType == "SVA" || m.Model.KinParamType == "" {
		...
		for _, joint := range m.Model.Joints {
			...
			if joint.Type == "revolute" {
				...
				rev := frame.NewRevoluteFrame(joint.ID, spatialmath.R4AA{RX: joint.Axis.X, RY: joint.Axis.Y, RZ: joint.Axis.Z})
		...
		for _, dh := range m.Model.DHParams {
			...
			j := frame.NewRevoluteFrame(jointID, spatialmath.R4AA{RX: 0, RY: 0, RZ: 1})
