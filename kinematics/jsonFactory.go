...
func ParseJSON(jsonData []byte) (*Model, error) {
	...
	// Go through the tolerance piece by piece, updating any values that exist
	if m.Model.Tolerances != nil {
		if m.Model.Tolerances.Translation != nil {
			model.DistCfg.Trans.X = m.Model.Tolerances.Translation.X
			model.DistCfg.Trans.Y = m.Model.Tolerances.Translation.Y
			model.DistCfg.Trans.Z = m.Model.Tolerances.Translation.Z
		}
		if m.Model.Tolerances.Orientation != nil {
			model.DistCfg.Orient.X = m.Model.Tolerances.Orientation.X
			model.DistCfg.Orient.Y = m.Model.Tolerances.Orientation.Y
			model.DistCfg.Orient.Z = m.Model.Tolerances.Orientation.Z
		}
	}
