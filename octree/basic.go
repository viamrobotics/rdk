...
// until false is returned. These parameters are passing them to iterateRecursive along with the starting index
// (0) to iterate though a basic octree if the given number of batches is greater than 0.
