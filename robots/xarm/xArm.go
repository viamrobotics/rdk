...
func init() {
	registry.RegisterComponent(arm.ResourceSubtype.String(), "xArm6", registry.Component{
	...
	registry.RegisterComponent(arm.ResourceSubtype.String(), "xArm7", registry.Component{
		Constructor: func(ctx context.Context, r robot.Robot, config config.Component, logger golog.Logger) (interface{}, error) {
