...
func init() {
	registry.RegisterSensor(compass.Type, "fake", &registry.SensorRegistration{Constructor: func(ctx context.Context, r robot.Robot, config config.Component, logger golog.Logger) (sensor.Sensor, error) {
