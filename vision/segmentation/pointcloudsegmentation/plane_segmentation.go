...
func CreatePoints3DFromDepthMap(depthImage *rimage.DepthMap, pixel2meter float64, params rimage.PinholeCameraIntrinsics, depthMin, depthMax rimage.Depth) *Points3D {
...
func (pts *Points3D) ProjectPlane3dPointsToRGBPlane(h, w int, params rimage.PinholeCameraIntrinsics, pixel2meter float64) []r3.Vector {
...
// Function to project 3D point in a given camera image plane
func (pts *Points3D) ApplyRigidBodyTransform(params *rimage.Extrinsics) *Points3D {
...
func DepthMapToPointCloud(depthImage *rimage.DepthMap, pixel2meter float64, params rimage.PinholeCameraIntrinsics, logger golog.Logger) (*pc.PointCloud, error) {
