...
func init() {
	registry.RegisterSegmenter(RadiusClusteringVoxelSegmenter, registry.Segmenter{
		Constructor: func(ctx context.Context) (interface{}, error) { return Segmenter(RadiusClusteringFromVoxels), nil },
	})
}
