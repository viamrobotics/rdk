...
type Solver interface {
	...
	Solve(ctx context.Context, solutions chan<- *Solution, seed []float64, maxTravel float64, minFunc func([]float64) float64, rseed int) error
}
...
func SolveMetric(
	...
	return ik.Solve(ctx, solutionChan, referenceframe.InputsToFloats(seed), 0, minFunc, rseed)
}
