...
func (pm *planManager) planSingleAtomicWaypoint(
	...
	wp atomicWaypoint,
	maps *rrtMaps,
) (referenceframe.FrameConfigurations, *resultPromise, error) {
...
func (pm *planManager) plannerSetupFromMoveRequest(
	from, to *PlanState,
	seedMap referenceframe.FrameConfigurations, // A known good configuration to set up collsiion constraints. Not necessarily `from`.
