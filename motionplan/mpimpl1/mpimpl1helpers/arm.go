// Package mpimpl1helpers is helpers for mpimpl1
package mpimpl1helpers
...
func MoveArm(ctx context.Context, logger logging.Logger, a arm.Arm, dst spatialmath.Pose) error {
	...
	plan, err := mpimpl1.PlanFrameMotion(ctx, logger, dst, model, inputs, defaultArmPlannerOptions, nil)
	if err != nil {
		return err
	}
