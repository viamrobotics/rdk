...
func TestGetInterpreter(t *testing.T) {
	goodInterpreterLoader := func(model tflite.Model, options tflite.InterpreterOptions) (*tflite.Interpreter, error) {
		return &tflite.Interpreter{}, nil
	}

	goodOptions := func(numThreads int) (*tflite.InterpreterOptions, error) { return &tflite.InterpreterOptions{}, nil }
...
func TestFailedInterpreter(t *testing.T) {
	badInterpreterLoader := func(model tflite.Model, options tflite.InterpreterOptions) (*tflite.Interpreter, error) {
