...
func TestNew(t *testing.T) {
	...
	registry.RegisterLidar(string(devType), registry.LidarRegistration{Constructor: func(ctx context.Context, r robot.Robot, conf config.Component, logger golog.Logger) (lidar.Lidar, error) {
		return newFunc(conf)
	}})
