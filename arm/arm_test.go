...
func TestArmPositionDiff(t *testing.T) {
	...
	test.That(t, PositionGridDiff(&pb.ArmPosition{X: 1, Y: 1, Z: 1}, &pb.ArmPosition{}), test.ShouldAlmostEqual, utils.CubeRoot(3))
	...
	test.That(t, PositionRotationDiff(&pb.ArmPosition{RX: 1, RY: 1, RZ: 1}, &pb.ArmPosition{}), test.ShouldAlmostEqual, utils.CubeRoot(3))
}
